...
int main(){
    ...
    if(n % 4 == 0){  
        for(int i=0; i<n/4; i++){
            cout << n*2 - 2 - 4*i << " to " << -1 + 4*i << "\n";
            cout << -1 + 4*i + 4 << " to " << n*2 - 2 - 4*i << "\n";
        }
        ...
        cout << n + 1 << " to " << n - 2 << "\n";
        for(int i=0; i<n/4; i++){
            if(i == 0) cout << 4*i << " to " << n + 1 << "\n";
            else cout << 4*i << " to " << n + 4*i << "\n";
            cout <<  n + 4 + 4*i << " to " << 4*i << "\n";
        }
    }
        ...
        for(int i=0; i<n/4; i++){
            cout << n*2 - 4 - 4*i << " to " << -1 + 4*i << "\n";
            cout << -1 + 4*i + 4 << " to " << n*2 - 4 - 4*i << "\n";
        }
        ...
        for(int i=0; i<n/4 - 1; i++){
            cout << n + 1 + 4*i << " to " << n - 4 - 4*i << "\n";
            cout << n - 8 - 4*i << " to " << n + 1 + 4*i << "\n";
        }
        cout << n << " to " << 2 << "\n";
        cout << 0 << " to " << n << "\n";
        if(n == 6) {
        ...
        for(int i=0; i<n/4 - 2; i++){
            cout << n + 8 + 2*i << " to " << 5 + 4*i << "\n";
            cout << 5 + 4 + 4*i << " to " << n + 8 + 2*i << "\n";
        }
        cout << 2*n - 1 << " to " << n - 5 << "\n";
    }
